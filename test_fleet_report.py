...
def test_summary_does_not_crash_on_missing_reading():
    # A fleet that contains a car with no last_service_km must not crash.
    # average_wear must be present in the result and computed only over cars that have a reading.
    fleet = [
        {"id": "VOS-4471", "odometer": 14900, "last_service_km": 0},
